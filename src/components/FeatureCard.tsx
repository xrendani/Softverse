  ...
  return (
    <div 
      className={cn(
        ...
        isHovered && !disabled && "border-softverse-purple/50 shadow-lg",
        disabled && "opacity-60 cursor-not-available",
        className
      )}
    ...
    >
      <div className="flex items-start">
        <div className={cn(
          ...
          isHovered && !disabled ? "bg-softverse-purple text-white" : "bg-softverse-purple/10 text-softverse-purple"
        )}>
        ...
        <div className="ml-4">
          <div className="flex items-center gap-2">
            <h3 className={cn(
              ...
              isHovered && !disabled && "text-softverse-purple"
            )}>
              {title}
            </h3>
            {comingSoon && (
